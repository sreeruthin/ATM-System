...
public class ATM {
    ...
    private boolean step4_initialDeposit(double[] depositRef) {
        ...
        try {
            ...
            if (initialDeposit < 0 || (initialDeposit > 0 && initialDeposit % 100 != 0)) {
                System.out.println("Error: Initial deposit must be 0 or a multiple of 100 (no decimals).");
                return false;
            }
    ...
    private void deposit() {
        ...
        try {
            ...
            if (amount <= 0 || amount % 100 != 0) {
                System.out.println("Error: Deposit amount must be a multiple of 100 (no decimals).");
                pauseToContinue();
                return;
            }
        } catch (NumberFormatException e) {
    ...
    private void withdraw() {
        ...
        try {
            amount = Double.parseDouble(scanner.nextLine());
            if (amount <= 0 || amount % 100 != 0) {
                System.out.println("Error: Withdrawal amount must be a multiple of 100 (no decimals).");
                pauseToContinue();
                return;
            }
        } catch (NumberFormatException e) {
    ...
    private void transferMoney() {
        ...
        try {
            amount = Double.parseDouble(scanner.nextLine());
            if (amount <= 0 || amount % 100 != 0) {
                System.out.println("Error: Transfer amount must be a multiple of 100 (no decimals).");
                pauseToContinue();
                return;
            }
        } catch (NumberFormatException e) {
