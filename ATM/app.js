        ...
        <div class="glass-card">
            ...
            <form onsubmit="event.preventDefault(); handleCreateStep3();">
                <div class="form-group">
                    ...
                    <input type="number" id="newDeposit" placeholder="0.00" min="0" step="0.01">
                </div>
        ...
        <div class="glass-card">
            ...
            <form onsubmit="event.preventDefault(); handleDeposit();">
                <div class="form-group">
                    ...
                    <input type="number" id="depAmount" placeholder="0.00" min="0.01" step="0.01">
                </div>
        ...
        <div class="glass-card">
            ...
            <form onsubmit="event.preventDefault(); handleWithdraw();">
                <div class="form-group">
                    ...
                    <input type="number" id="withAmount" placeholder="0.00" min="0.01" step="0.01">
                </div>
...
function handleCreateStep3() {
    ...
    if (isNaN(deposit) || deposit < 0) {
        showMessage('create-alert', 'Please enter a valid non-negative amount.', 'error');
        return;
    }
...
function handleDeposit() {
    ...
    if (isNaN(amount) || amount <= 0) {
        showMessage('action-alert', 'Enter a valid amount greater than 0.', 'error');
        return;
    }
...
function handleWithdraw() {
    ...
    if (isNaN(amount) || amount < 100) {
        showMessage('action-alert', 'Minimum withdrawal amount is 100.', 'error');
        return;
    }
        ...
        <div class="glass-card">
            ...
            <form onsubmit="event.preventDefault(); handleTransfer();">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="transAmount" placeholder="0.00" min="0.01" step="0.01">
                </div>
